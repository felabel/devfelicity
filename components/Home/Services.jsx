          ...
          <div className="mb hd ca">
            <div className="bc df">
              <div className="vc fa sg fb">
                ...
                <h2 className="dh jh wg wj kk oa">My Services</h2>
                <p className="eh _g lh">There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb hd ca">
            <div className="bc ek/2 wm/4 df">
              <div className="oe dj ri wh of lf ud e z od sg di ma">
                <div
                  className="fa kc xb eb td pe mb id kd kh fj gj"
                >
                  <svg width="35" height="33" viewBox="0 0 35 33" className="ye">
                    <path
                ...
                <h3 className="dh jh zg yj km 2xl:ud-text-2xl hj ua">User Research</h3>
                <p className="eh lh hj ih vg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ligulavel in.</p>
                <div>
            ...
            <div className="bc ek/2 wm/4 df">
              <div className="oe dj ri wh of lf ud e z od sg di ma">
                <div
                  className="fa kc xb eb td pe mb id kd kh fj gj"
                >
                  <svg width="36" height="36" viewBox="0 0 36 36" className="ye">
                    <path
                ...
                <h3 className="dh jh zg yj km 2xl:ud-text-2xl hj ua">Visual Design</h3>
                <p className="eh lh hj ih vg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ligulavel in.</p>
                <div>
                  <span className="d f q nn">
                    <svg width="218" height="109" viewBox="0 0 218 109" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bc ek/2 wm/4 df">
              <div className="oe dj ri wh of lf ud e z od sg di ma">
                <div
                  className="fa kc xb eb td pe mb id kd kh fj gj"
                >
                  <svg width="40" height="25" viewBox="0 0 40 25" className="ye">
                    <path
                ...
                <h3 className="dh jh zg yj km 2xl:ud-text-2xl hj ua">User Testing</h3>
                <p className="eh lh hj ih vg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ligulavel in.</p>
                <div>
                  <span className="d f q nn">
                    <svg width="218" height="109" viewBox="0 0 218 109" fill="none" xmlns="http://www.w3.org/2000/svg">
