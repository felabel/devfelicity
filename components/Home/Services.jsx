              ...
              <div className="bc df">
                <div className="vc fa sg fb">
                  ...
                  <p className="eh _g lh">
                    I specialize in crafting high-quality digital experiences
                    tailored to your needs. Here’s what I bring to the table:
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb hd ca">
              <div className="bc ek/2 wm/4 df">
                <div className="oe dj ri wh of lf ud e z od sg di ma">
                  ...
                  <h3 className="dh jh zg yj km 2xl:ud-text-2xl hj ua">
                    Web Development
                  </h3>
                  <p className="eh lh hj ih vg">
                    Building professional websites that are fast, functional,
              ...
              <div className="bc ek/2 wm/4 df">
                <div className="oe dj ri wh of lf ud e z od sg di ma">
                  ...
                  <p className="eh lh hj ih vg">
                    Ensuring quality with rigorous testing to deliver flawless
                    digital products. Jest, Vitest and Cypress for E2E tests.
                  </p>
                  <div>
                    <span className="d f q nn">
                      <svg
              ...
              <div className="bc ek/2 wm/4 df">
                <div className="oe dj ri wh of lf ud e z od sg di ma">
                  ...
                  <p className="eh lh hj ih vg">
                    Bringing innovative ideas to life through scalable and
                    modern web apps.
                  </p>
                  <div>
                    <span className="d f q nn">
