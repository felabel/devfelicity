...
const Footer = () => {
  return (
    <div>
      <footer className="qe ag bg e z">
        <div className="a">
          <div className="mb hd ga">
            <div className="bc ek/2 kl/12 df">
              <div className="la">
                <h2 className="dh kh xg hh oa">Let's Talk!</h2>
                <h3 className="dh kh qh yg ta">Contact Info</h3>
                <p className="eh ug lh qa">
                  <a
                    href="https://portfolio-tailwind.preview.uideck.com/cdn-cgi/l/email-protection"
                    className="__cf_email__"
                    data-cfemail="99faf5f6eafcebe9f8fefcd9fcf4f8f0f5b7faf6f4"
                  >
                    [email&#160;protected]
                  </a>
                </p>
                <p className="eh ug lh qa">12 Hilton St, Manchester M1 1JF</p>
                <p className="eh ug lh qa">+44 012 34 5678</p>
              </div>
            </div>
            <div className="bc ek/2 ll/12 df">
              <div className="la">
                <h3 className="fh kh zg wa">What I Do?</h3>
                <ul>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui">
                      {" "}
                      The Studio{" "}
                    </a>
                  </li>
            ...
            <div className="bc ek/2 ml/12 df">
              <div className="la">
                <h3 className="fh kh zg wa">News</h3>
                <ul>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui">
                      {" "}
            ...
            <div className="bc ek/2 ll/12 df">
              <div className="la">
                <h3 className="fh kh zg wa">Quick Links</h3>
                <ul>
                  <li>
                    <a href="javascript:void(0)" className="lb ug lh ua ui">
                      {" "}
          ...
          <div className="xa cg _d ee ke">
            <div className="mb id kd oa">
              <a
                href="javascript:void(0)"
                className="mb id kd gc tb on ha lh ui"
              ...
              <a
                ...
                name="social-link"
              >
                <svg width="32" height="32" viewBox="0 0 32 32" className="ye">
            ...
            <p className="eh ug lh sg">
              All rights reserved by © Portfolio creative 2024
            </p>
          </div>
        </div>

        <div className="d g k nn" aria-label="shape" name="shape">
          <span className="ob">shape</span>
          <svg
            width="143"
            height="138"
            viewBox="0 0 143 138"
        ...
        <div className="d l m nn" aria-label="shape" name="shape">
          <span className="ob">shape</span>
          <svg
            width="61"
            height="77"
